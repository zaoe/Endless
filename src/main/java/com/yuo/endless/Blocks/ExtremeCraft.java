...
import com.yuo.endless.Gui.ExtremeCraftContainer;
...
public class ExtremeCraft extends Block {
    ...
    public ExtremeCraft() {
        super(Properties.create(Material.ROCK).hardnessAndResistance(10, 10).harvestLevel(1)
    ...
    public INamedContainerProvider getContainer(BlockState state, World worldIn, BlockPos pos) {
        return new SimpleNamedContainerProvider((id, inventory, player) -> {
            return new ExtremeCraftContainer(id, inventory, (ExtremeCraftTile) worldIn.getTileEntity(pos), IWorldPosCallable.of(worldIn, pos));
        }, CONTAINER_NAME);
    }
